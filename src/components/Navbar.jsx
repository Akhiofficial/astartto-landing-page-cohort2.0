...
const Navbar = () => {
    return (
        <div className='flex justify-between items-center px-16 py-6 border-b border-zinc-200 '>
            <div className="flex gap-14 text-sm font-medium text-zinc-800">
                <a href="#">Services</a>
                <a href="#">Work</a>
                <a href="#">About</a>
            </div>
            ...
            <div className="flex items-center gap-10">
                <a href="#" className="text-sm font-medium text-zinc-800">Careers</a>
